...
MISSION_SERVICE_DIR="/Users/brianhickey/Desktop/Fidelity Leap - Instructor Portal/ReusedMissionProjects/mission-spring-boot-sprint6"
...
echo "== auth image build completed =="
docker build -t "$SERVICE_IMAGE" "$MISSION_SERVICE_DIR"
echo "== mission service sprint6 build completed =="
